      ...
      <Link to={`/addon/${addon.source}/${detailId}`} className="block">
        <div className="flex gap-3 p-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-gray-400 mt-0.5">by {addon.author}</p>
        ...
        <p className="px-4 text-xs text-gray-400 line-clamp-2">
          {addon.summary}
        </p>
      </Link>

      <div className="flex gap-2 p-3 mt-2 border-t border-gray-700">
