  ...
  return (
    <div>
      ...
      <div className="card p-6 mb-6">
        <div className="flex gap-5">
          {addon.thumbnailUrl ? (
            ...
            <div className="w-24 h-24 rounded-xl bg-gray-700 flex items-center justify-center flex-shrink-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-gray-400 mt-1">by {addon.author}</p>
      ...
      <div className="card p-5 mb-6">
        <p className="text-gray-300">{addon.summary}</p>
      </div>
      ...
      {addon.description && addon.description !== addon.summary && (
        <div className="card p-6 mb-6">
          ...
          <div
            className="addon-description prose prose-invert max-w-none text-sm text-gray-300
              [&_h1]:text-xl [&_h1]:font-bold [&_h1]:text-gray-100 [&_h1]:mt-4 [&_h1]:mb-2
              [&_h2]:text-lg [&_h2]:font-bold [&_h2]:text-gray-100 [&_h2]:mt-4 [&_h2]:mb-2
              [&_h3]:text-base [&_h3]:font-semibold [&_h3]:text-gray-200 [&_h3]:mt-3 [&_h3]:mb-1
              [&_p]:mb-2 [&_p]:leading-relaxed
              [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:mb-3
              [&_ol]:list-decimal [&_ol]:pl-5 [&_ol]:mb-3
              [&_li]:mb-1
              [&_a]:text-bedrock-400 [&_a]:underline hover:[&_a]:text-bedrock-300
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
            {addon.screenshots.map((url, i) => (
              <button
                ...
                className="rounded-lg overflow-hidden border border-gray-700 hover:border-gray-500 transition-colors"
              >
                <img
                  src={url}
                  alt={`Screenshot ${i + 1}`}
